 ...
 *
 * 通过命令进行开关Log.isLoggable中第一个参数替换xxx
 * 重启失效
 * adb shell setprop log.tag.${xxx} V
 * adb shell getprop log.tag.${xxx}
 */
public class KLog {
    ...
    private static final String LINE_SEPARATOR = null == System.getProperty("line.separator") ? "/" : System.getProperty("line.separator");
    ...
    private static void printLog(int type, String tagStr, Object objectMsg) {
        ...
        if (!IS_SHOW_LOG && !Log.isLoggable(TAG, Log.DEBUG)) {
            return;
        }
        ...
        switch (type) {
            ...
            case JSON: {
                ...
                try {
                    ...
                    e(tag, e.getCause());
                    e(tag, "please check json format:");
                    e(tag, msg);
                    return;
                }
