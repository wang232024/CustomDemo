...
import com.example.custom.utils.constant.RegexConstants;
...
public final class RegexUtils {
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isSecrectCode(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_SECRET_CODE, input);
    }
}
